...
### 3.2: Paho
A versão do Paho para Javascript utilizada é a 1.1.0. Ao publicarmos as mensagens com esta biblioteca, não estamos definindo o QoS pois por default o QoS na publicação de mensagens é 0. Também não estamos informando o QoS ao assinarmos tópicos pois por default o QoS definido é 0. Já na conexão com o Mosquitto estamos definindo o id do usuário no broker como o id do usuário informado por ele mesmo no início da aplicação. Também não estamos definindo o path pois o path definido por default pelo Pahot é /mqtt.
