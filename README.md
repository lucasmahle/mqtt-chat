...
Após o login, é possivel criar grupos, pedir permissão para fazer parte de um grupo onde é enviado a solicitação para o lider do grupo, que pode aceitar ou recusar o pedido para participar do grupo, após o lider aceitar a solicitação é possivel os usuarios enviarem mensagens dentro do grupo, pode ser feita a exclusão do grupo pelo lider do grupo.
